...
The multiple-choice questions should have the reference to the source which page and line the question is generated from.
...
The format of the out put is json that follow the format below
